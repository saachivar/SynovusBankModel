...
export const ApplicationSubmittedModal: React.FC<ApplicationSubmittedModalProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-sm text-center p-6">
        ...
        <p className="text-sm text-gray-600 mt-2">
            Thank you. Your application for a new account has been received. You will be notified of the decision within 1-2 business days.
        </p>
        <button
          onClick={onClose}
